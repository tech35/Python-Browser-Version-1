...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        title = QLabel("Tech35's Python Browser")
        font = title.font()
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action.setStatusTip("Find out more about This Browser")  # Hungry!
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Tech35's Python Browser" % title)

    def navigate_mozarella(self):
        self.browser.setUrl(QUrl("https://www.github.com/tech35"))
...
app.setOrganizationDomain("https://tech35.github.io")
